...
define('CANVAS_API_URL', 'Your Canvas instance URL goes here]/api/v1');

define('OAUTH_CLIENT_ID', 'Your Instructure-issued client ID');
define('OAUTH_CLIENT_KEY', 'Your Instructure-issued client secret');

define('MYSQL_HOST', 'Your MySQL hostname');
